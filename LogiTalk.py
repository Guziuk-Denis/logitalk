...
class MainWindow(CTk):
    def __init__(self):
        ...
        self.name_label = CTkLabel(self.top_frame, text="Your name:")
        self.name_label.pack(side="left")

        self.name_entry = CTkEntry(self.top_frame, placeholder_text="name")
        self.name_entry.pack(side="left", padx=(5, 0), fill="x", expand=True)

        self.rename_button = CTkButton(self.top_frame, text="Rename", width=100, command=self.rename)
        self.rename_button.pack(side="left", padx=5)

        self.theme_menu = CTkOptionMenu(self.top_frame, values=["dark", "light"], command=self.change_theme)
        ...
        self.message_input = CTkEntry(self.bottom_frame, placeholder_text="Enter message")
